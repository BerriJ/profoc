...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type p_smooth_lambda(p_smooth_lambdaSEXP);
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type p_smooth_knot_distance(p_smooth_knot_distanceSEXP);
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type p_smooth_knot_distance_power(p_smooth_knot_distance_powerSEXP);
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type p_smooth_deg(p_smooth_degSEXP);
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type p_smooth_ndiff(p_smooth_ndiffSEXP);
    Rcpp::traits::input_parameter< const int >::type parametergrid_max_combinations(parametergrid_max_combinationsSEXP);
    Rcpp::traits::input_parameter< Rcpp::Nullable<Rcpp::NumericMatrix> >::type parametergrid(parametergridSEXP);
...
// online
Rcpp::List online(mat& y, cube& experts, Rcpp::NumericVector tau, const int& lead_time, const std::string loss_function, const double& loss_parameter, const bool& loss_gradient, const std::string method, const std::string method_var, Rcpp::NumericVector basis_knot_distance, Rcpp::NumericVector basis_knot_distance_power, Rcpp::NumericVector basis_deg, Rcpp::NumericVector forget_regret, Rcpp::NumericVector soft_threshold, Rcpp::NumericVector hard_threshold, Rcpp::NumericVector fixed_share, Rcpp::NumericVector p_smooth_lambda, Rcpp::NumericVector p_smooth_knot_distance, Rcpp::NumericVector p_smooth_knot_distance_power, Rcpp::NumericVector p_smooth_deg, Rcpp::NumericVector p_smooth_ndiff, Rcpp::NumericVector gamma, const int parametergrid_max_combinations, Rcpp::Nullable<Rcpp::NumericMatrix> parametergrid, const double& forget_past_performance, std::string sorting, Rcpp::Nullable<Rcpp::NumericMatrix> init_weights, Rcpp::NumericVector loss_array, Rcpp::NumericVector regret_array, const bool trace);
RcppExport SEXP _profoc_online(SEXP ySEXP, SEXP expertsSEXP, SEXP tauSEXP, SEXP lead_timeSEXP, SEXP loss_functionSEXP, SEXP loss_parameterSEXP, SEXP loss_gradientSEXP, SEXP methodSEXP, SEXP method_varSEXP, SEXP basis_knot_distanceSEXP, SEXP basis_knot_distance_powerSEXP, SEXP basis_degSEXP, SEXP forget_regretSEXP, SEXP soft_thresholdSEXP, SEXP hard_thresholdSEXP, SEXP fixed_shareSEXP, SEXP p_smooth_lambdaSEXP, SEXP p_smooth_knot_distanceSEXP, SEXP p_smooth_knot_distance_powerSEXP, SEXP p_smooth_degSEXP, SEXP p_smooth_ndiffSEXP, SEXP gammaSEXP, SEXP parametergrid_max_combinationsSEXP, SEXP parametergridSEXP, SEXP forget_past_performanceSEXP, SEXP sortingSEXP, SEXP init_weightsSEXP, SEXP loss_arraySEXP, SEXP regret_arraySEXP, SEXP traceSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< mat& >::type y(ySEXP);
    ...
    Rcpp::traits::input_parameter< Rcpp::Nullable<Rcpp::NumericMatrix> >::type parametergrid(parametergridSEXP);
    Rcpp::traits::input_parameter< const double& >::type forget_past_performance(forget_past_performanceSEXP);
    Rcpp::traits::input_parameter< std::string >::type sorting(sortingSEXP);
    ...
    Rcpp::traits::input_parameter< const bool >::type trace(traceSEXP);
    rcpp_result_gen = Rcpp::wrap(online(y, experts, tau, lead_time, loss_function, loss_parameter, loss_gradient, method, method_var, basis_knot_distance, basis_knot_distance_power, basis_deg, forget_regret, soft_threshold, hard_threshold, fixed_share, p_smooth_lambda, p_smooth_knot_distance, p_smooth_knot_distance_power, p_smooth_deg, p_smooth_ndiff, gamma, parametergrid_max_combinations, parametergrid, forget_past_performance, sorting, init_weights, loss_array, regret_array, trace));
    return rcpp_result_gen;
END_RCPP
}
// predict_online
...
static const R_CallMethodDef CallEntries[] = {
    {"_profoc_batch", (DL_FUNC) &_profoc_batch, 29},
