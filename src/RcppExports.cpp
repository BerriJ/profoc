...
// online_rcpp
Rcpp::List online_rcpp(mat& y, arma::field<cube>& experts, vec tau, const unsigned int& lead_time, const std::string loss_function, const double& loss_parameter, const bool& loss_gradient, const std::string method, const mat& param_grid, const double& forget_past_performance, bool allow_quantile_crossing, const cube w0, const cube R0, const field<cube>& loss_array, const field<cube>& regret_array, const bool trace);
...
// predict_online
Rcpp::List predict_online(Rcpp::List& object, arma::field<cube>& new_experts, const bool& update_model);
RcppExport SEXP _profoc_predict_online(SEXP objectSEXP, SEXP new_expertsSEXP, SEXP update_modelSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::List& >::type object(objectSEXP);
    Rcpp::traits::input_parameter< arma::field<cube>& >::type new_experts(new_expertsSEXP);
    Rcpp::traits::input_parameter< const bool& >::type update_model(update_modelSEXP);
    rcpp_result_gen = Rcpp::wrap(predict_online(object, new_experts, update_model));
    return rcpp_result_gen;
END_RCPP
}
// update_online
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_profoc_predict_online", (DL_FUNC) &_profoc_predict_online, 3},
