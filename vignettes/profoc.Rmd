...
These are averages over time, over the probability grid, and possibly also over all marginals. The losses of the Experts and the Forecaster can be accessed via `results$experts_loss` and `results$forecaster_loss` respectively.
