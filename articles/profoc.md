...
[`online()`](https://profoc.berrisch.biz/reference/online.md) offers a
high-level interface to the learning algorithms and their extensions. It
is a wrapper to the C++ class `conline`. The class functions as a
...
[`online()`](https://profoc.berrisch.biz/reference/online.md) to run the
core algorithms. We also show how the results can be inspected. Various
popular extensions of the core algorithms, methods for deployment in
production, and the low-level interface will be covered in separate
vignettes.
...
Most parameters of
[`online()`](https://profoc.berrisch.biz/reference/online.md) contain
sensible defaults. So, in this example, it is sufficient to provide the
data and the probability grid.
...
[`online()`](https://profoc.berrisch.biz/reference/online.md) in
production for predicting and updating, refer to
[`vignette("production")`](https://profoc.berrisch.biz/articles/production.md).
